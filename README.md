...
| 이름   | 역할 |
|--------|------|
| 안동현  | 게임 시스템(대화, 퀘스트, 스토리 진행, 튜토리얼, UI 기능), 로비 기능, 보스 기능, 리뷰 씬, 스테이지 2 기능 수정, 시스템 도큐먼트 작성, 게임 전체 연결, 빌드, 영상 제작 |
| 백윤성  | 스테이지 1-1 기능, 스테이지 1 퀘스트 구현, git(PR) 관리, 일정 관리, 프로젝트 전체 관리 |
| 최선아  | 스테이지 2-2 기능, 스테이지 2-2 퀘스트 구현, 스테이지 2 NPC 대화, 에셋 서치, 보고서 작성, 발표 |
| 신수연  | 스테이지 1-2 기능(+퀘스트 연결), 스테이지 2-1 기능 구현, 보고서 작성, 발표 |
